...
class main_window:
    def __init__(self, root):
        self.root = root
        self.root.title("ID card generator with qr code")
        self.root.geometry("1400x800")
        self.root.resizable()

        # Creating a label to write a title
        self.title = Label(self.root,
                           text="ID card generator with qr code",
                           font=('cooper', 20, 'bold'),
                           pady=20,
                           bg='#292421',
                           fg='#ffffff'
        ...
        self.birthdate_entry = Entry(self.frame1,
        ...
        self.birthdate_entry.place(x=180, y=260)
    ...
    def Generate(self):
        ...
        if self.Name.get() == '' or self.Gender.get() == '' or self.Age.get() == '' or self.birthDate.get() == '' or self.Phone.get() == '' or self.Email.get() == '':
            ...
            self.Drw.text((20, 100), 
                          'Full Name:', 
                          fill='#000000', 
                          font=fon)
            
            self.Drw.text((20, 150), 
                          'Gender:', 
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((20, 200), 
                          'Age:', 
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((20, 250), 
                          'Birthdate:', 
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((20, 300), 
                          'Phone:', 
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((20, 350), 
                          'Email:', 
                          fill='#000000', 
                          font=fon
                          )

            self.Drw.text((250, 100), 
                          self.Name.get(),
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((250, 150), 
                          self.Gender.get(),
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((250, 200), 
                          self.Age.get(), 
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((250, 250), 
                          self.birthDate.get(),
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((250, 300), 
                          self.Phone.get(),
                          fill='#000000', 
                          font=fon
                          )
            
            self.Drw.text((250, 350), 
                          self.Email.get(),
                          fill='#000000', 
                          font=fon
                          )
            ...
            self.Qrcode.add_data(
                f'Full Name: {self.Name.get()}\nGender: {self.Gender.get()} \nAge: {self.Age.get()} \nBirthdate: {self.birthDate.get()} \nPhone: {self.Phone.get()} \nEmail: {self.Email.get()} ')
            self.Qrcode.make(fit=True)
            self.Qr = self.Qrcode.make_image(
